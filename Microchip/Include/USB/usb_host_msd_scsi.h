...
//
// These functions are used by the Microchip Memory Disk Drive File System
// (AN1045).
// *****************************************************************************
// *****************************************************************************
...
/****************************************************************************
  Function:
    WORD ReadByte( BYTE *pBuffer, WORD index )

  Description:
    This function reads an 8-bit byte from a byte buffer.
  ...
  Returns:
    BYTE - Byte value at specified location

  Remarks:
    None
  ***************************************************************************/

#define ReadByte( p,i ) p[i]
...
/****************************************************************************
  ...
  Description:
    This function reads a 16-bit word from a byte buffer.
  ...
  Returns:
    WORD - Word value at specified location

  Remarks:
    This function is necessary, since the WORD may not be aligned in the byte
    buffer.
  ***************************************************************************/
...
/****************************************************************************
  ...
  Description:
    This function reads a 32-bit double word from a byte buffer.
  ...
  Returns:
    DWORD - Double word at specified location

  Remarks:
    This function is necessary, since the DWORD may not be aligned in the
    byte buffer.
  ***************************************************************************/
...
#define InitIO()            // Unneeded - initialization is now done in the File System code.
...
#define MediaInitialize     USBHostMSDSCSIMediaInitialize   // Used to access USBHostMSDSCSIMediaInitialize(), for compatibility with the File System code
